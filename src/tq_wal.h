...
extern bool tq_wal_set_batch_summary_entry(Relation relation,
										   ...
										   char *errmsg,
										   size_t errmsg_len);
extern bool tq_wal_init_exact_key_page(Relation relation,
									   Buffer buffer,
									   uint32_t key_bytes,
									   uint16_t entry_capacity,
									   uint32_t next_block,
									   char *errmsg,
									   size_t errmsg_len);
extern bool tq_wal_set_exact_key_next_block(Relation relation,
											Buffer buffer,
											uint32_t next_block,
											char *errmsg,
											size_t errmsg_len);
extern bool tq_wal_append_exact_key(Relation relation,
									Buffer buffer,
